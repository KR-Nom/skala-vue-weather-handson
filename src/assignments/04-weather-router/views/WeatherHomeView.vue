 ...
 * 작성자: 장현진
 * 작성일: 2026-08-27
 * 변경사항: 과제 3의 8개 도시·검색·선택·즐겨찾기 기능을 유지하고 상세 이동 추가
 * 프로그램 설명: 독립 날씨 컴포넌트를 연결하고 상세 페이지로 이동하는 메인 화면
 */
...
import WeatherCard from '../../03-weather-components/components/WeatherCard.vue'
